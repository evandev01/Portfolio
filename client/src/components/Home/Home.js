                ...
                <Card id='card'>
                  ...
                  <Accordion.Collapse eventKey='0'>
                    <Card.Body className='white-para'>
                      ...
                      <Card.Text>
                        React portfolio highlighting projects with bio and
                        contact form that sends messages to my email inbox upon
                        submission.
                        <br />
                        <br />
                        Responsibilities:
                        ...
                        Technologies:
                        <br />
                        React, Javascript, Node, Express, Nodemailer, Mailtrap,
                        React-bootstrap, CSS
                        <br />
                        <br />
                        <Card.Link
                ...
                <Card id='card'>
                  ...
                  <Accordion.Collapse eventKey='0'>
                    <Card.Body className='white-para'>
                      ...
                      <Card.Text>
                        React application designed to allow user to allow user
                        to create, save, store and delete calendar events and
                        addresses.
                        <br />
                        <br />
                        Responsibilities:
                ...
                <Card id='card'>
                  ...
                  <Accordion.Collapse eventKey='0'>
                    <Card.Body className='white-para'>
                      ...
                      <Card.Text>
                        Fun application that allows the user to create a burger,
